...
export default function CreateListing() {
    ...
    useEffect(()=>{
        // self invoking function inside useEffect
      ;(async()=>{
    ...
    return (
        <main className='p-3 max-w-4xl mx-auto'>
            <h1 className='font-semibold text-3xl text-center my-7'>Edit Listing</h1>

            <form onSubmit={handleSubmit} className='flex flex-col gap-4 sm:flex-row'>

                <div className='flex flex-col gap-4 flex-1'>
                    <input type="text" placeholder='Name' className='border p-3 outline-none rounded-lg' required id='name' maxLength='62' minLength="10"
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    >{submitting ? "updating..." : "update listing"}</button>
